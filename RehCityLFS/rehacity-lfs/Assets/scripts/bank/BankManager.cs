    ...
    */
        ...
        private void SetupOptions()
        {
            ...
            for (var i = 0; i < 10; i++)
            {
                ...
                tempKeyObject.transform.FindChild("Cylinder").renderer.material.color = new Color(0, 0, 0, 0);
            }
            ...
            for (var i = 0; i < MultiBanco.SubOptions.Count; i++)
            {
                ...
                selectionarrows[i].GetComponentInChildren<Text>().text = MultiBanco.SubOptions[i].Description;
                selectionarrows[i].GetComponentInChildren<Text>().name = MultiBanco.SubOptions[i].Description;
            }
