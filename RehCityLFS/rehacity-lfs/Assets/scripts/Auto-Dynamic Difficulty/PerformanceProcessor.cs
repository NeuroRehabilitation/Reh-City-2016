...
namespace Assets.scripts
{
    public class PerformanceProcessor : MonoBehaviour {
        ...
        public static void ProcessPerformance()
        {
            ...
            else if (FirstTimeProcessing && NumberOfLocations > 0)
            {
                DomainsDivisor -= 1;
            ...
            {
                if (ObjectiveInstatiation.GetObjectivesList()[i].Completed)
                {
            ...
            if (DomainsDivisor >= 8)
            {
                ...
                ModelProfile.UpdateModelProfile(Main_Menu.Uid, CurrentProfileModel.Attention, CurrentProfileModel.Memory, CurrentProfileModel.ExFunctions, CurrentProfileModel.Language, CurrentProfileModel.Difficulty);
                FirstTimeProcessing = false;
                Debug.Log(CurrentProfileModel.Attention + " ; " + CurrentProfileModel.Memory + " ; " + CurrentProfileModel.ExFunctions + " ; " + CurrentProfileModel.Language + " ; " + CurrentProfileModel.Difficulty);
            }
            LoadSaveSettings.SaveSettingsInfo("EndLevelOrGameProcessing");
            
        }

        public static void ResetPerformanceVariables()
        {
