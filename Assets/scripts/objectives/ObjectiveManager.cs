...
namespace Assets.scripts.objectives
{
    public class ObjectiveManager :MonoBehaviour{
        ...
        private void GetNewObjectiveList()
        {
            ...
            GameManager.Instance.ShowArrowObject = !(PerformanceProcessor.CurrentProfileModel.Difficulty > 9);
            GameManager.Instance.ToggleArrowDisplay();
            
            if (PerformanceProcessor.CurrentProfileModel.Difficulty > 10)
                PerformanceProcessor.CurrentProfileModel.Difficulty = 10;
            //DynamicAdapter.CurrentProfileModel.Difficulty = DynamicAdapter.CurrentProfileModel.Difficulty + 0.5f;
            ...
            //var randomnumber = Random.Range(0, LevelListManager.LevelList.Count);
            //_levelList = LevelListManager.LevelList[randomnumber];
