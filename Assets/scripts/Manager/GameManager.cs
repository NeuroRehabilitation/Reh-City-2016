...
namespace Assets.scripts.Manager
{
    public class GameManager : MonoBehaviour
    {
        ...
        /// </summary>
        [HideInInspector] public bool ShowArrowObject = false;//true;
        ...
        private static List<GameObject> _cars = new List<GameObject>();
        ...
        public void ToggleArrowDisplay()
        {
            ...
            _cars.Clear();
            _cars = GameObject.FindGameObjectsWithTag("Car").ToList();
            if (ShowCars && Application.loadedLevelName == "City")
            {
