...
namespace Assets.scripts.Controller
{
    public class ikLimbRight : MonoBehaviour {
        ...
        void CalculateIK(){
            ...
            {
                targetRelativeStartPosition = target.transform.position - upperArm.position;
            }
                ...
                lastElbowTargetPosition == elbowTarget.position) 
            {
                if(debug) 
                {
                    ...
                    Debug.DrawLine(upperArm.position, target.transform.position, Color.red);
                }
            ...
            float targetDistance = Vector3.Distance(upperArm.position, target.transform.position);	
            ...
            //Reset arm.
            target.transform.position = targetRelativeStartPosition + upperArm.position;
            ...
            upperArmAxisCorrection.transform.LookAt(target.transform, elbowTarget.position - upperArmAxisCorrection.transform.position);
            ...
            forearmAxisCorrection.transform.LookAt(target.transform, elbowTarget.position - upperArmAxisCorrection.transform.position);
            handAxisCorrection.transform.rotation = target.transform.rotation;
