...
namespace Assets.scripts.GUI.StartSCene
{
    public class StartSceneSettings : MonoBehaviour
    {
        ...
        private bool /*_showArrow = true,*/ _showCars = true;
        ...
        public Text loadingText, playText, quitText, controlsText, optionsText, MainMenuText, SelectionTimeValue;
        ...
        public Toggle pt, en, calib, minimap, navigation, objective, leftHand, rightHand, citySigns, ItemsLabels, MoCaProfileToggle, ModelProfileToggle, EduMoCaToggle, CarsToggle;
        ...
        public static bool DoCalibration;

        private string _btnName;
        private int _selectionTime = 6;

        public static bool UseNewSelectionTime;
        ...
        private void SetLevel()
        {
            ...
            GameManager.Instance.ShowArrowObject = false;//_showArrow;
            GameManager.ShowCars = _showCars;
            ...
            ObjectiveManager.Instance.GetLevelAndAddObjective(1);
        ...
        public void MainMenuButton(int option)
        {
            ...
            TimerCount.StartTime = _selectionTime;
        }
        ...
        private void SetLanguageText()
        {
            ...
            if (_inputOptions)
            {
                ...
                //_showArrow = false;//navigation.isOn;
                _showCars = CarsToggle.isOn;
        ...
        public void UpdateSelectionTime(int value)
        {
            if((value > 0 && _selectionTime < 9) || (value < 0 && _selectionTime > 1))
            {
                _selectionTime += value;
                SelectionTimeValue.text = _selectionTime.ToString();
                TimerCount.StartTime = _selectionTime;
                UseNewSelectionTime = true;
            }
        }
        ...
        public void UpdateUserValues()
        {
            ...
            _selectionTime = (int)TimerCount.StartTime;
            SelectionTimeValue.text = TimerCount.StartTime.ToString("0");
        ...
        private void UpdateprofileBars()
        {
            if (MoCaProfileToggle.isOn)
            {
