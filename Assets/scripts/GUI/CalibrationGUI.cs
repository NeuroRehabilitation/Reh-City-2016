...
namespace Assets.scripts.GUI
{
    public class CalibrationGUI : MonoBehaviour {
        ...
        public static bool CalibProcess = false;//if true, calibration is in process
        public static bool CalibSteps = false;//boolean that helps to indicate when to display _steps
        public static bool CalibDone = false;//boolean that indicates if calibration has been already done
